        ...
        observation: {
            ...
            candidates: [{
                ...
                span: {
                    ...
                    startByte: target.span.startByte ?? 0,
                    endByte: target.span.endByte ?? 0,
                    startColumn: target.span.startColumn ?? 0,
                    endColumn: target.span.endColumn ?? 0,
                },
                name: target.name,
                qualifiedName: target.qualifiedName,
                symbolInstanceId: target.symbolInstanceId,
            }],
        },
...
test('admitResolvedCallClaims validates authority, symbol existence, source file match, and span containment', () => {
    ...
    const validClaim = {
        ...
        observation: {
            ...
            candidates: [{
                file: 'src/math.ts',
                span: { startByte: 0, endByte: 1, startLine: 1, startColumn: 0, endLine: 1, endColumn: 1 },
                name: 'add',
                qualifiedName: 'add',
                symbolInstanceId: 'inst-target',
            }],
