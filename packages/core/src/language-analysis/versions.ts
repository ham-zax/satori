...
export const RELATIONSHIP_BUILDER_VERSION = 'relationship-v17+cbm-multilang-v1+python-cross-module-constructors+python-native-resolution-v2+scala-syntactic-calls-v1+js-this-member-calls-v1+typescript-compiler-resolution-v6+relationship-evidence-v1';
