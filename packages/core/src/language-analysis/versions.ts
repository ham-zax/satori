...
export const SYMBOL_EXTRACTOR_VERSION = `language-analysis-v4+${LANGUAGE_PARSER_VERSION}`;
export const RELATIONSHIP_BUILDER_VERSION = 'relationship-v3+utf8-normalized-analysis';
