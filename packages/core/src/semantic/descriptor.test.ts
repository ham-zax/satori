...
test('defaultSemanticLanguageRegistry loads from packaged assets and supports Go', () => {
    ...
    assert.equal(
        ...
        'relationship-v17+cbm-multilang-v1+python-cross-module-constructors+python-native-resolution-v2+scala-syntactic-calls-v1+js-this-member-calls-v1+typescript-compiler-resolution-v4+relationship-evidence-v1',
    );
